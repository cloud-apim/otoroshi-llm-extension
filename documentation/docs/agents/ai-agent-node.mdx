...
The `content_to_markdown` tool uses [Kreuzberg](https://github.com/Filimoa/kreuzberg) to convert documents (PDF, DOCX, HTML, images, etc.) into markdown text. The agent can provide either a URL or base64-encoded content.

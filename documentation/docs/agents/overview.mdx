...
- **Built-in tools**: Agents come with a library of ready-to-use tools (filesystem, shell, HTTP, tasks, plan, memory, agent delegation) that can be enabled per agent without any external configuration

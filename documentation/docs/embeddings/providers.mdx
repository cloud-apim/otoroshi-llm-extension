...
Uses OVH's unified OpenAI-compatible API. Just set your `token` and the embedding `model` you want to use.
...
| OpenAI Compatible | OpenAI | (your model) | varies | Configurable name & headers |
| OVH AI Endpoints | OpenAI | — | varies | Unified API 🇫🇷 🇪🇺 |

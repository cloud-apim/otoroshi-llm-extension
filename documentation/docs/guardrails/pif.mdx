...
- **model**: The model of that provider to use, its default model when omitted. With a model set, the guarded provider can judge its own messages with another of its models.  

...
|-----------|------|:--------:|---------|-------------|
| `provider` | string | Yes | — | Reference ID of the LLM provider used to evaluate prompt injection risk. Must be different from the main provider, unless a `model` is set. |

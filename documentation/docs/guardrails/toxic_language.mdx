...
|-----------|------|:--------:|---------|-------------|
| `provider` | string | Yes | — | Reference ID of the LLM provider used to evaluate messages for toxic language. Must be different from the main provider, unless a `model` is set. |

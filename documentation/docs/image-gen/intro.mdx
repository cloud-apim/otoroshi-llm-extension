...
| [Arkane Cloud](/docs/image-gen/models#arkane-cloud) | Yes | No | `stability-ai/sdxl` |
| [OpenAI Compatible](/docs/image-gen/models#openai-compatible) | Yes | Yes | — |
| [OVH AI Endpoints](/docs/image-gen/models#ovh-ai-endpoints) 🇫🇷 🇪🇺 | Yes | Yes | — |

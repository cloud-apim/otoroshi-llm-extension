...
| Feature | OpenAI | Azure | Cloud Temple | Gemini | Grok | Luma | Hive | OVH |
|---------|:------:|:-----:|:------------:|:------:|:----:|:----:|:----:|:---:|
| Generation | Yes | Yes | Yes | Yes | Yes | Yes | Yes | Yes |
| Editing | Yes | No | Yes | Yes | No | No | No | Yes |
| Size control | Yes | Yes (restricted) | Yes | Yes | No | No | Yes (w/h) | Yes |
| Quality control | Yes | Yes | Yes | Yes | No | No | Yes | Yes |
| Style control | Yes | Yes | Yes | Yes | No | No | No | Yes |
| Seed/reproducibility | No | No | No | No | No | No | Yes | No |
| Inference steps | No | No | No | No | No | No | Yes | No |

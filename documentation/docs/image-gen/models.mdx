...
| Feature | OpenAI | Azure | Cloud Temple | Gemini | Grok | Luma | Hive | OVH | OAI Compat |
|---------|:------:|:-----:|:------------:|:------:|:----:|:----:|:----:|:---:|:----------:|
| Generation | Yes | Yes | Yes | Yes | Yes | Yes | Yes | Yes | Yes |
| Editing | Yes | No | Yes | Yes | No | No | No | Yes | Yes |
| Size control | Yes | Yes (restricted) | Yes | Yes | No | No | Yes (w/h) | Yes | Yes |
| Quality control | Yes | Yes | Yes | Yes | No | No | Yes | Yes | Yes |
| Style control | Yes | Yes | Yes | Yes | No | No | No | Yes | Yes |
| Seed/reproducibility | No | No | No | No | No | No | Yes | No | No |
| Inference steps | No | No | No | No | No | No | Yes | No | No |

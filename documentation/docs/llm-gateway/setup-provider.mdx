...
Model restrictions can also be applied at the API key level using metadata:
- `ai_models_include`: comma-separated list of include patterns
- `ai_models_exclude`: comma-separated list of exclude patterns

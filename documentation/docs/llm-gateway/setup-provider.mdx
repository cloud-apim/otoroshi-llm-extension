...
The `guardrails` array configures content validation rules that are applied before and/or after LLM calls. See the [Guardrails documentation](/docs/category/-guardrails) for all available guardrails.

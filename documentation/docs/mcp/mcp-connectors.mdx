...
| `mcp_request` | object | A summary of the request (e.g. tool name and arguments for `tools/call`, uri for `resources/read`) |
| `mcp_response` | object | A summary of the upstream response (e.g. item counts for list operations, the result for `tools/call`) |
...
```json
{
  ...
  "mcp_response": { "result": "issue #42 created" },
  "duration": 318,
  "status": "success",
  "error": null,
  "user": null,

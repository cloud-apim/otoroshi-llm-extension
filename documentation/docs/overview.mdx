...
**Connect, setup, secure and seamlessly manage LLM models using an Universal/OpenAI compatible API**
  ...
  - [**MCP Connectors**](/docs/function-calling/mcp-connectors)
    - [**💸 Stripe**](/docs/function-calling/mcp-connectors-examples/stripe-mcp)
    - [**Slack**](/docs/function-calling/mcp-connectors-examples/slack-mcp)
    - [**Make**](/docs/function-calling/mcp-connectors-examples/make-mcp)
    - [**ScreenshotOne**](/docs/function-calling/mcp-connectors-examples/screenshotone-mcp)
    - [**Redis**](/docs/function-calling/mcp-connectors-examples/redis-mcp)
    - [**Perplexity Ask**](/docs/function-calling/mcp-connectors-examples/perplexity-mcp)
    - [**Mailgun**](/docs/function-calling/mcp-connectors-examples/mailgun-mcp)
    - [**Grafana**](/docs/function-calling/mcp-connectors-examples/grafana-mcp)
    - [**Gitlab**](/docs/function-calling/mcp-connectors-examples/gitlab-mcp)
    - [**Firecrawl**](/docs/function-calling/mcp-connectors-examples/firecrawl-mcp)
    - [**Brave Search**](/docs/function-calling/mcp-connectors-examples/brave-api-mcp)
    - [**AWS KB Retrieval**](/docs/function-calling/mcp-connectors-examples/aws-mcp)
    - [**EverART**](/docs/function-calling/mcp-connectors-examples/everart-mcp)
    - [**Puppeteer**](/docs/function-calling/mcp-connectors-examples/puppeteer-mcp)
    - [**Google Maps**](/docs/function-calling/mcp-connectors-examples/google-maps-mcp)

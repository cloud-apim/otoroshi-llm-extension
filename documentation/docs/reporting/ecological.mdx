...
The extension ships a ready-made **Ecological impact** dashboard in Otoroshi's user dashboards — see
[Built-in dashboards](./dashboards.mdx).

![The AI Gateway ecological impact dashboard in Otoroshi](/img/ai-gateway-dashboard-ecology.png)

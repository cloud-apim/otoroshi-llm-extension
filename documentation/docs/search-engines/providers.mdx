...
| `config.embedding_model_name` | string | default model of the embedding model | Model of that embedding model to use. It must be the model the documents of the store were embedded with |

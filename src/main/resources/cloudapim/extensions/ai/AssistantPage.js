  ...
  componentDidMount() {
    ...
    if (!document.getElementById('otoroshi-assistant-styles')) {
      ...
      style.innerHTML = [
        ...
        '.otoroshi-assistant-message-md > *:first-child { margin-top: 0 !important; }',
        '.otoroshi-assistant-message-md > *:last-child { margin-bottom: 0 !important; }',
        '.otoroshi-assistant-message-md h1, .otoroshi-assistant-message-md h2, .otoroshi-assistant-message-md h3, .otoroshi-assistant-message-md h4, .otoroshi-assistant-message-md h5, .otoroshi-assistant-message-md h6 { font-weight: 600; line-height: 1.3; margin: 8px 0 4px 0; }',
        '.otoroshi-assistant-message-md h1 { font-size: 16px; }',
        '.otoroshi-assistant-message-md h2 { font-size: 15px; }',
        '.otoroshi-assistant-message-md h3 { font-size: 14px; }',
        '.otoroshi-assistant-message-md h4, .otoroshi-assistant-message-md h5, .otoroshi-assistant-message-md h6 { font-size: 13px; color: var(--text-muted); }',

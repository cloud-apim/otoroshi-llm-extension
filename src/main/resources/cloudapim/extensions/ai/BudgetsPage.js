function RemainingBudget(props) {
  ...
  return (
    React.createElement('div', null,
      ...
      React.createElement("div", { className: "row mb-3" },
        React.createElement("label", { className: "col-xs-12 col-sm-2 col-form-label" }, 'Remaining OCR USD'),
        React.createElement("div", { className: "col-sm-10", style: { lineHeight: '33px' } }, `${remaining.remaining_ocr_usd} $`),
      ),
      React.createElement("div", { className: "row mb-3" },
        React.createElement("label", { className: "col-xs-12 col-sm-2 col-form-label" }, 'Remaining OCR pages'),
        React.createElement("div", { className: "col-sm-10", style: { lineHeight: '33px' } }, `${remaining.remaining_ocr_pages} pages`),
      ),
      React.createElement("div", { className: "row mb-3" },
...
class BudgetsPage extends Component {
  ...
  formSchema = (state) => ({
    ...
    'limits.ocr_usd': {
      type: 'number',
      props: {label: 'OCR USD', suffix: '$' },
    },
    'limits.ocr_pages': {
      type: 'number',
      props: {label: 'OCR Pages', suffix: 'pages' },
    },
    'limits.remaining': {

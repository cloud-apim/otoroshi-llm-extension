...
object DocResource {
  ...
  val startingPoints: Seq[StartingPoint] = Seq(
    ...
    StartingPoint("admin-api-features-and-capabilities", "Admin API features & capabilities", "https://maif.github.io/otoroshi/devmanual/docs/topics/generic-resource-api",
      "Features and capabilities the Otoroshi Admin API with all default endpoints, etc"),
    StartingPoint("detailed-topics", "Detailed topics", "https://www.otoroshi.io/docs/topics",
    ...
    StartingPoint("basic-route-setup", "Basic route setup", "https://www.otoroshi.io/docs/getting-started", "Learn how to setup a basic route with apikeys support"),

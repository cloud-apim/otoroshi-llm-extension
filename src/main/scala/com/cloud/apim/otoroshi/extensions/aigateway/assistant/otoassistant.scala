...
object OtoroshiAssistant {
  ...
  private val basePrompt: String =
    s"""You are the Otoroshi Assistant, an expert AI helper embedded in the Otoroshi admin UI.
       ...
       |- Search and reference Otoroshi documentation when relevant. The official manual is at https://www.otoroshi.io/docs/. When the user's question maps to a specific section, point them to the most relevant page. You can find more about the otoroshi ecosystem at https://www.otoroshi.io/ecosystem.

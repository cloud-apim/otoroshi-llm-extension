...
case class OpenAiLikeProviderDef(
                                  ...
                                  // other OpenAI-shaped endpoints the provider documents on the same base url
                                  // (`/images/generations`, `/audio/transcriptions`, `/audio/speech`, `/moderations`)
                                  supportsImages: Boolean = false,
                                  supportsSpeechToText: Boolean = false,
  ...
  def json: JsObject = Json.obj(
    ...
    "supports_speech_to_text" -> supportsSpeechToText,
    "supports_text_to_speech" -> supportsTextToSpeech,
    "supports_moderation"    -> supportsModeration,
  )
}
...
object OpenAiLikeProviders {
  ...
  val all: Seq[OpenAiLikeProviderDef] = Seq(
    ...
    OpenAiLikeProviderDef("veniceai",      "Venice AI",        "https://api.venice.ai/api/v1",                              apiKeyEnv = Some("VENICE_AI_API_KEY"), supportsEmbeddings = true, supportsImages = true, supportsSpeechToText = true, supportsTextToSpeech = true),
    OpenAiLikeProviderDef("xiaomi-mimo",   "Xiaomi Mimo",      "https://api.xiaomimimo.com/v1",         mct,                apiKeyEnv = Some("XIAOMI_MIMO_API_KEY")),
    OpenAiLikeProviderDef("synthetic",     "Synthetic",        "https://api.synthetic.new/openai/v1",   mct,                apiKeyEnv = Some("SYNTHETIC_API_KEY"), supportsEmbeddings = true),
    OpenAiLikeProviderDef("apertis",       "Apertis",          "https://api.apertis.ai/v1",             mct,                apiKeyEnv = Some("STIMA_API_KEY"), supportsEmbeddings = true, supportsSpeechToText = true, supportsTextToSpeech = true),
    OpenAiLikeProviderDef("nano-gpt",      "Nano GPT",         "https://nano-gpt.com/api/v1",           mct,                apiKeyEnv = Some("NANOGPT_API_KEY"), supportsEmbeddings = true, supportsSpeechToText = true, supportsTextToSpeech = true, supportsModeration = true),
    ...
    OpenAiLikeProviderDef("deepinfra",     "DeepInfra",        "https://api.deepinfra.com/v1/openai",   mct,                apiKeyEnv = Some("DEEPINFRA_API_KEY"), supportsEmbeddings = true, supportsImages = true, supportsSpeechToText = true, supportsTextToSpeech = true),
    OpenAiLikeProviderDef("empower",       "Empower",          "https://app.empower.dev/api/v1",                            apiKeyEnv = Some("EMPOWER_API_KEY")),
    OpenAiLikeProviderDef("featherless-ai","Featherless AI",   "https://api.featherless.ai/v1",         mct,                apiKeyEnv = Some("FEATHERLESS_AI_API_KEY"), supportsEmbeddings = true, supportsTextToSpeech = true),
    OpenAiLikeProviderDef("fireworks-ai",  "Fireworks AI",     "https://api.fireworks.ai/inference/v1", mct,                apiKeyEnv = Some("FIREWORKS_API_KEY"), supportsEmbeddings = true),
    OpenAiLikeProviderDef("friendliai",    "Friendli AI",      "https://api.friendli.ai/serverless/v1",                     apiKeyEnv = Some("FRIENDLIAI_API_KEY"), supportsSpeechToText = true),
    ...
    OpenAiLikeProviderDef("nebius",        "Nebius Token Factory", "https://api.tokenfactory.nebius.com/v1", mct,          apiKeyEnv = Some("NEBIUS_API_KEY"),        supportsEmbeddings = true),
    OpenAiLikeProviderDef("novita",        "Novita AI",        "https://api.novita.ai/v3/openai",                           apiKeyEnv = Some("NOVITA_API_KEY")),
    OpenAiLikeProviderDef("nscale",        "Nscale",           "https://inference.api.nscale.com/v1",                       apiKeyEnv = Some("NSCALE_API_KEY"), supportsEmbeddings = true, supportsImages = true),
    OpenAiLikeProviderDef("nvidia-nim",    "Nvidia NIM",       "https://integrate.api.nvidia.com/v1",   mct,                apiKeyEnv = Some("NVIDIA_NIM_API_KEY"), supportsEmbeddings = true),
    ...
    OpenAiLikeProviderDef("together-ai",   "Together AI",      "https://api.together.ai/v1",                               apiKeyEnv = Some("TOGETHERAI_API_KEY"), supportsEmbeddings = true, supportsImages = true, supportsSpeechToText = true, supportsTextToSpeech = true),
    OpenAiLikeProviderDef("zai",           "Z.AI",             "https://api.z.ai/api/paas/v4",                              apiKeyEnv = Some("ZAI_API_KEY"), supportsImages = true, supportsSpeechToText = true),
